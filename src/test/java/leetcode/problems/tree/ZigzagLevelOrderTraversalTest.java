...
class ZigzagLevelOrderTraversalTest {
	...
	private ZigzagLevelOrderTraversal underTest = new ZigzagLevelOrderTraversal();
	
	@ParameterizedTest
	@MethodSource
	void testWithParams(TreeNode root, List<List<Integer>> expected) {
		List<List<Integer>> actual = underTest.zigzagLevelOrder(root);
	...
	private static Stream<Arguments> testWithParams() {
		...
		TreeNode list1L2Node2 = new TreeNode(20, list1L3Node1, list1L3Node2);
		TreeNode list1L1Node1 = new TreeNode(3, list1L2Node1, list1L2Node2);
		
		List<List<Integer>> tree1Out = Arrays.asList(Arrays.asList(3), Arrays.asList(20,9), 
				Arrays.asList(15,7));
