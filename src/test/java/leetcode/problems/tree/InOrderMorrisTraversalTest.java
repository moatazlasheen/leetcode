...
class InOrderMorrisTraversalTest {
	...
	private InOrderMorrisTraversal underTest = new InOrderMorrisTraversal();
	
	@ParameterizedTest
	@MethodSource
	void testWithParams(TreeNode root, List<Integer> expected) {
		List<Integer> actual = underTest.inorderTraversal(root);
	...
	private static Stream<Arguments> testWithParams() {
		...
		List<Integer> tree1Out = Arrays.asList(1,3,2);
