...
public class ImageRotation {
	...
	// flips the image around the horizontal axis at the middle of the image
	...
	// mirrors the image around the second diagon from the left bottom corner to the right upper corner 
